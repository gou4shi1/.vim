...
call coc_fzf#common#add_list_source('files', 'open files in cwd', 'Leaderf file .')                               " LeaderF
call coc_fzf#common#add_list_source('pfiles', 'open files in project', 'Leaderf file')                            " LeaderF
call coc_fzf#common#add_list_source('buffers', 'display open buffers', 'Leaderf buffer')                          " LeaderF
call coc_fzf#common#add_list_source('mru', 'most recently used files in cwd', 'Leaderf mru --cwd')                " LeaderF
call coc_fzf#common#add_list_source('lines', 'lines in current buffer', 'Leaderf line --nowrap')                  " LeaderF
call coc_fzf#common#add_list_source('quickfix', 'quickfix list', 'Leaderf quickfix')                              " LeaderF
call coc_fzf#common#add_list_source('locationlist', 'location list', 'Leaderf loclist')                           " LeaderF
call coc_fzf#common#add_list_source('helptags', 'helptags of vim', 'Leaderf help')                                " LeaderF
call coc_fzf#common#add_list_source('functions', 'functions in current buffer', 'Leaderf function')               " LeaderF
