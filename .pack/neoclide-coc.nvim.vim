let g:coc_global_extensions=['coc-lists', 'coc-yank', 'coc-fzf-preview', 'coc-clangd', 'coc-json', 'coc-sh', 'coc-python', 'coc-go', 'coc-tsserver', 'coc-eslint', 'coc-prettier', 'coc-styled-components', 'coc-react-refactor']
